...
const crearEquipo = (equipo, gf, gc) => {
  ...
  equipos[equipo] = {
    ...
    "ganados" : calcularPts(gf, gc) === 3 ? 1 : 0,
    "perdidos" : calcularPts(gf, gc) === 0 ? 1 : 0,
    "empatados" : calcularPts(gf, gc) === 1 ? 1 : 0,
    "jugados" : 1
  };
};
...
const actualizarEquipo = (equipo, nuevosGF, nuevosGC) => {
  ...
  equipo['ganados'] += calcularPts(nuevosGF, nuevosGC) === 3 ? 1 : 0;
  equipo['perdidos'] += calcularPts(nuevosGF, nuevosGC) === 0 ? 1 : 0;
  equipo['empatados'] += calcularPts(nuevosGF, nuevosGC) === 1 ? 1 : 0;
  equipo['jugados'] ++;
};
